...
func InitReturnCodes(lang language.Tag) {
	...
	ReturnCodes[NOT_ALL_PREVIOS_MANDATORY_STATUSES_ARE_SET] = "Not all previos mandatory statuses are set for status '<StatusName>'. Requried statuses for '2-POINT LINE TASK': 'STARTED', 'FINISHED'"
	...
	ReturnCodes[INSTANCE_IS_FINISHED] = "Cannot access this instance. Token '<InstanceToken>' is already finished"
	...
	ReturnCodes[NOT_ALL_MANDATORY_ARE_SET] = "Not all mandatory statuses are set for instance '<InstanceToken>'. Required statuses: "
